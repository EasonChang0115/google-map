<template>
  <div id="menu" :class="{ close: toggle }">
    ...
    <perfect-scrollbar :options="scrollOptions" ref="scroll" @ps-scroll-y="onScroll">
      <div class="search">
        <div class="select">
          <select name="citys" v-model="selectedCity">
            <option v-for="(item, key) in cities.counties" :key="key" :value="item">{{ item }}</option>
          </select>
        ...
        <div class="select">
          <select name="districts" v-model="selectedDistrict">
            ...
            <option v-for="(item, key) in getDistricts" :key="key" :value="item">{{ item }}</option>
          </select>
          <div class="select_arrow"></div>
        </div>
      </div>
